...
class AddEditProduct extends StatefulWidget {
  static const routeName = '/items_add_edit';
    ...
    return Scaffold(
      ...
      body: BlocConsumer<ItemBloc, ItemState>(
        ...
        if (itemState is ItemsLoadSuccess) {
          ...
          Scaffold.of(context).showSnackBar( SnackBar(content: Text("operation success")));
        }
        ...
        return Form(
          ...
          child: SingleChildScrollView(
            ...
            children: [
              ...
              formName(item, _productNameController, onItemSaved,"product Name", _nameValidator, ),
              formNumber(item, _priceTextController, onPriceSaved, "price"),
